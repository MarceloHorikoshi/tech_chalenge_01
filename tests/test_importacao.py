...
def test_filtrar_exportacao_sem_token(importacao_entrada, expected_json):
    client = TestClient(app)
...
def test_insere_importacao_sem_token():
    ...
    client = TestClient(app)
    response = client.post('/importacao', json=exportacao_insert)
...
def test_altera_importacao_sem_token():
    ...
    client = TestClient(app)
    response = client.put('/exportacao/10254', json=importacao_alteracao)
...
def test_deleta_exportacao_item_inexistente():
    client = TestClient(app)
    response = client.delete(f'/exportacao/99999999', headers=headers)
